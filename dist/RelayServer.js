...
class RelayServer extends events_1.default {
    ...
    async getMaxPossibleGas(req, isDeployRequest) {
        ...
        if (!this.config.allowForSponsoredTx) {
            ...
            const tokenAmountInGas = Conversions_1.getGas(Conversions_1.getWeiFromRifWei(web3_utils_1.toBN(req.relayRequest.request.tokenAmount)), web3_utils_1.toBN(req.relayRequest.relayData.gasPrice));
